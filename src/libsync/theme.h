...
#ifndef TOKEN_AUTH_ONLY
    Q_PROPERTY(QColor wizardHeaderTitleColor READ applicationTitleColor CONSTANT)
    Q_PROPERTY(QColor wizardHeaderBackgroundColor READ applicationBackgroundColor CONSTANT)
#endif
